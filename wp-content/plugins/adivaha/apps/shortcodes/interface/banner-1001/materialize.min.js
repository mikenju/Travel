        ...
        a(document).ready(function() {
            ...
            a(this).each(function() {
                if ($select = a(this), !$select.hasClass("browser-default")) {
                    ...
                    if (c && ($select.parent().find("i").remove(), $select.parent().find("input").remove(), $select.unwrap(), a("ul#select-options-" + c).remove()), "destroy" === b) return void jQueryselect.data("select-id", null).removeClass("initialized");
