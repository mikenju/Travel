angular.module("adivahaPopularDestinationsZeroZeroTwo", [
    'elif',
    'adivahaPopularDestinationsZeroZeroTwo.directives'
])


angular.element(document).ready(function() {
    var element = angular.element(document.querySelector('#adivahaDestinationsZeroZeroTwo'));
    var isInitialized = element.injector();
    if (!isInitialized) {
        angular.bootstrap(element, ['adivahaPopularDestinationsZeroZeroTwo']);
    }
...
'use strict';
/* Controllers */
angular.module('adivahaPopularDestinationsZeroZeroTwo.directives', [])
    /* Starting of Adiaha Hotel Search Box*/
    .directive('adivahaPopularDestinationsZeroZeroTwo', function() {
        return {
            controller: function($scope, $http) {

            },
            template: '<div class="adi_prellex2 adi-full sectionfour">' +
                '<div class="adi-full">' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar1').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview1').value + ')</span></span> | <span class="">' + document.getElementById('tourbook1').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices1').value + '</b></span><span class="">' + document.getElementById('tourday1').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar2').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview2').value + ')</span></span> | <span class="">' + document.getElementById('tourbook2').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices2').value + '</b></span><span class="">' + document.getElementById('tourday2').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar3').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview3').value + ')</span></span> | <span class="">' + document.getElementById('tourbook3').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices3').value + '</b></span><span class="">' + document.getElementById('tourday3').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar4').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview4').value + ')</span></span> | <span class="">' + document.getElementById('tourbook4').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices4').value + '</b></span><span class="">' + document.getElementById('tourday4').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar5').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview5').value + ')</span></span> | <span class="">' + document.getElementById('tourbook5').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices5').value + '</b></span><span class="">' + document.getElementById('tourday5').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar6').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview6').value + ')</span></span> | <span class="">' + document.getElementById('tourbook6').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices7').value + '</b></span><span class="">' + document.getElementById('tourday7').value + '</span></p></div>' +
                '</a>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar7').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview7').value + ')</span></span> | <span class="">' + document.getElementById('tourbook7').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices7').value + '</b></span><span class="">' + document.getElementById('tourday7').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar8').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview8').value + ')</span></span> | <span class="">' + document.getElementById('tourbook8').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices8').value + '</b></span><span class="">' + document.getElementById('tourday8').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar9').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview9').value + ')</span></span> | <span class="">' + document.getElementById('tourbook9').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices9').value + '</b></span><span class="">' + document.getElementById('tourday9').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
                ...
                '<div class="star_box"><span class=""><span class="m_star"><i class="fa fa-star"></i><span class="">&nbsp;' + document.getElementById('tourstar10').value + '</span></span><span class="">&nbsp;(' + document.getElementById('tourreview10').value + ')</span></span> | <span class="">' + document.getElementById('tourbook10').value + '</span></div>' +
                '<div class="price"><p><span class="latest_price"><b>' + document.getElementById('tourprices10').value + '</b></span><span class="">' + document.getElementById('tourday10').value + '</span></p></div>' +
                '</a>' +
                '</div>' +
